...
// import { FiShoppingCart, FiArrowLeft, FiCheckCircle, FiPlus, FiMinus } from "react-icons/fi";
...
//                 <span className="text-gray-600 line-through mr-2">₹{Math.round(product.price*1.2).toLocaleString("en-IN")}</span>
//                 <span className="text-green-600 font-medium bg-green-100 px-2 py-1 rounded">
//                   20% OFF
//                 </span>
//               </div>
//               <p className="mt-2 text-gray-600">EMI starts at ₹{Math.round(totalPrice/12).toLocaleString("en-IN")}/month</p>
//             </div>
...
//                 </button>
//                 <div className="px-4 py-2 border-t border-b border-gray-300 bg-gray-50 text-center w-16">
//                   {quantity}
//                 </div>
//                 <button 
//                   onClick={() => handleQuantityChange(quantity + 1)}
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white py-12 px-4 sm:px-6 lg:px-8">
      ...
      {showConfirmation && (
        <div className="fixed top-20 right-4 z-50">
          <div className="bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg flex items-center animate-fade-in-out">
